    ...
    return (
        <div className="step-content">
            <div className="form-group">
                <label className="form-label" htmlFor="town_hall_level">
                    Town Hall Level
                </label>
                <select
                    id="town_hall_level"
                    name="town_hall_level"
                    className={`form-select ${errors.town_hall_level ? "error" : ""}`}
                ...
                {errors.town_hall_level && <div className="form-error">{errors.town_hall_level}</div>}
            </div>

            <div className="form-group">
                <label className="form-label" htmlFor="builder_hall_level">
                    Builder Hall Level
                </label>
                <select
            ...
            <div className="form-row">
                <div className="form-col">
                    <div className="form-group">
                        <label className="form-label" htmlFor="gems">
                            Gems
                        </label>
                        <input
                            type="number"
                ...
                <div className="form-col">
                    <div className="form-group">
                        <label className="form-label" htmlFor="trophies">
                            Trophies
                        </label>
                        <input
                            type="number"

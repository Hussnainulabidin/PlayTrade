      ...
      <header className="border-b border-[#2d2b3a] bg-[#1a172b] sticky top-0 z-50 shadow-md">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 border border-[#2d2b3a] rounded-md px-3 py-1.5">
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex flex-col sm:flex-row items-start sm:items-center">
            ...
            <div className="flex-1 mb-3 sm:mb-0">
              <div className="flex">
                <button className="px-4 py-2 border-b-2 border-[#7c3aed] flex items-center">
                  <svg
            ...
            <div className="flex w-full sm:w-auto gap-2">
              ...
              <button className="flex-1 sm:flex-none bg-[#7c3aed] hover:bg-[#6d28d9] px-3 sm:px-4 py-2 rounded-md flex items-center justify-center text-sm sm:text-base">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 mr-2">
                  <path
                    fillRule="evenodd"
              ...
              >
                <div className="p-4 border-b border-gray-800">
                  ...
                  <div className="space-y-1 text-sm">
                    <div className="flex items-center gap-1">
                      <span>
                        {account.title?.length > 70 ?
                          `${account.title?.substring(0, 70)} . . .` :
                          account.title
                        }
                      </span>
                ...
                <div className="p-4 border-t border-gray-800 flex items-center justify-between">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      handleAccountClick(account._id);
                    }}
                  >
                    Buy Now
                    <svg
                ...
                <div className="p-3 border-t border-[#2d2b3a] flex items-center justify-between text-sm">
                  <div className="flex items-center gap-2">
                    <div className="w-5 h-5 bg-[#211f2d] rounded-full flex items-center justify-center text-xs font-semibold">

  ...
  useEffect(() => {
    const fetchAccounts = async () => {
      try {
        ...
        if (selectedServer && selectedServer !== "All Town Halls") {
          filters.townHallLevel = selectedServer
        }
        if (selectedPrice) {
        ...
        const response = await gameAccountApi.clashofclans.getAccounts(filters)
                ...
                <div className="p-4 border-b border-gray-800">
                  ...
                  <div className="space-y-1 text-sm">
                    <div className="flex items-center gap-1">
                      ...
                      {account.verified && <span className="bg-[#7c3aed] text-white text-xs px-2 py-1 rounded-full ml-2">✓</span>}
                    </div>

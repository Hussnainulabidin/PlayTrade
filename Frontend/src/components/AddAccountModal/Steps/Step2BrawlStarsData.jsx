    ...
    return (
        <div className="step-content">
            <div className="form-group">
                <label className="form-label" htmlFor="trophy_range">
                    Trophy Range
                </label>
                <select
                    id="trophy_range"
                    name="trophy_range"
                    className={`form-select ${errors.trophy_range ? "error" : ""}`}
                ...
                {errors.trophy_range && <div className="form-error">{errors.trophy_range}</div>}
            </div>

            <div className="form-row">
                <div className="form-col">
                    <div className="form-group">
                        <label className="form-label" htmlFor="brawlers_unlocked">
                            Brawlers Unlocked
                        </label>
                        <input
                            type="number"
